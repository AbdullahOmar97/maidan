...
class StudentBelt(models.Model):
    ...
    belt_rank = models.ForeignKey("tenants.Belt", on_delete=models.PROTECT, related_name="promotions")
...
class PromotionEligibility(models.Model):
    ...
    next_belt = models.ForeignKey("tenants.Belt", on_delete=models.SET_NULL, null=True, blank=True)
